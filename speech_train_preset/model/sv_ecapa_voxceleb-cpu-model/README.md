...
- **类型**: CPU 开源预训练模型
- **任务**: 声纹识别
- **来源**: `model/real_cpu_models/speechbrain-spkrec-ecapa-voxceleb/`
- **对应模型权重**: `model/sv_ecapa_voxceleb-cpu-model/model/sv_ecapa_voxceleb/`
...
```yaml
model_dir: "/workspace/model/sv_ecapa_voxceleb-cpu-model"
```
...
实际模型权重托管在 `model/real_cpu_models/speechbrain-spkrec-ecapa-voxceleb/` 下,
