...
- **类型**: CPU 开源预训练模型
- **任务**: 语音翻译
- **来源**: `model/real_cpu_models/Helsinki-NLP-opus-mt-en-zh/`
- **对应模型权重**: `model/mt_opus_mt_en_zh-cpu-model/model/mt_opus_mt_en_zh/`
...
```yaml
model_dir: "/workspace/model/mt_opus_mt_en_zh-cpu-model"
```
...
实际模型权重托管在 `model/real_cpu_models/Helsinki-NLP-opus-mt-en-zh/` 下,
