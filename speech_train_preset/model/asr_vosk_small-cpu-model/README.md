...
- **类型**: CPU 开源预训练模型
- **任务**: 语音识别
- **来源**: `model/real_cpu_models/vosk-model-small-en-us-0.15/`
- **对应模型权重**: `model/asr_vosk_small-cpu-model/model/asr_vosk_small/`
...
实际模型权重托管在 `model/real_cpu_models/vosk-model-small-en-us-0.15/` 下,
