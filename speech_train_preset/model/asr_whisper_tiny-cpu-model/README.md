# asr_whisper_tiny-cpu-model

## 资产说明

- **类型**: CPU 开源预训练模型
- **任务**: 语音识别
- **来源**: `model/real_cpu_models/openai-whisper-tiny/`
- **对应模型权重**: `model/asr_whisper_tiny-cpu-model/model/asr_whisper_tiny/`
...
```yaml
model_dir: "/workspace/model/asr_whisper_tiny-cpu-model"
```
...
实际模型权重托管在 `model/real_cpu_models/openai-whisper-tiny/` 下,
