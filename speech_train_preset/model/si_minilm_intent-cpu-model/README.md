...
- **类型**: CPU 开源预训练模型
- **任务**: 语音交互
- **来源**: `model/real_cpu_models/sentence-transformers-all-MiniLM-L6-v2/`
- **对应模型权重**: `model/si_minilm_intent-cpu-model/model/si_minilm_intent/`
...
```yaml
model_dir: "/workspace/model/si_minilm_intent-cpu-model"
```
...
实际模型权重托管在 `model/real_cpu_models/sentence-transformers-all-MiniLM-L6-v2/` 下,
