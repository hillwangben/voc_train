...
- **类型**: CPU 开源预训练模型
- **任务**: 语音纠错
- **来源**: `model/real_cpu_models/pycorrector-package-resources/`
- **对应模型权重**: `model/sc_pycorrector-cpu-model/model/sc_pycorrector/`
...
```yaml
model_dir: "/workspace/model/sc_pycorrector-cpu-model"
```
...
实际模型权重托管在 `model/real_cpu_models/pycorrector-package-resources/` 下,
