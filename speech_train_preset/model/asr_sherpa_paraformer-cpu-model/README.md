...
- **类型**: CPU 开源预训练模型
- **任务**: 语音识别
- **来源**: `model/real_cpu_models/sherpa-onnx-paraformer-zh-small-2024-03-09/`
- **对应模型权重**: `model/asr_sherpa_paraformer-cpu-model/model/asr_sherpa_paraformer/`
...
```yaml
model_dir: "/workspace/model/asr_sherpa_paraformer-cpu-model"
```
...
实际模型权重托管在 `model/real_cpu_models/sherpa-onnx-paraformer-zh-small-2024-03-09/` 下,
