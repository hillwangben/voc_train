...
- **类型**: CPU 开源预训练模型
- **任务**: 语音增强
- **来源**: `model/real_cpu_models/DeepFilterNet3/`
- **对应模型权重**: `model/ne_deepfilternet3-cpu-model/model/ne_deepfilternet3/`
...
```yaml
model_dir: "/workspace/model/ne_deepfilternet3-cpu-model"
```
...
实际模型权重托管在 `model/real_cpu_models/DeepFilterNet3/` 下,
